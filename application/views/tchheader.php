...
<div id="leftSide">
    ...
    <div class="genBalance">
        <a  title="" class="amount">
            ...
            <span class="balanceAmount"><?php echo $_SESSION['my_prj']; ?></span>
        </a>
    ...
    <ul id="menu" class="nav">
        <li class="dash"><a href="index.php/teacher/myproject" title="" class="active"><span>我的项目</span></a></li>
        <li class="dash"><a href="index.php/teacher/postprj" title="" class="active"><span>创建项目</span></a></li>
        <li class="charts"><a href="index.php/teacher/show_all_log" title=""><span>查看学生工作日志</span></a></li>
        <li class="forms"><a href="#" title="" class="exp"><span>项目管理</span><strong>3</strong></a>
            <ul class="sub">
                <li><a href="index.php/teacher/up_begin_page" title="">查看开题报告</a></li>
                <li><a href="index.php/teacher/up_mid_page" title="">查看中期报告</a></li>
                <li><a href="index.php/teacher/up_final_page" title="">查看结题报告</a></li>
            </ul>
        </li>
    </ul>
</div>
