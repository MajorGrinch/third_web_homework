...
<div class="loginWrapper">
    ...
    <div class="widget">
        ...
        <div class="clear"></div>
        <form action="index.php/test/checkpass" id="validate" class="form" method="post">
            <fieldset>
                <div class="formRow">
                    <label for="login">Username:</label>
                    <div class="loginInput"><input type="text" name="account" class="validate[required]" id="login" /></div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="loginCo trol">
                    ...
                    <div class"oprate">
                        <input type="submit" value="Log me in" class="dblueB logMeIn" />
                    </div>
                </div>
            </fieldset>
        </form>
        <form action="index.php/test/gotoregister" id="validate" class="form" method="post">
            <fieldset>
                <div class"oprate">
                    <input type="submit" value="Register" class="dblueB logMeIn" />
                </div>
            </fieldset>
        </form>
    </div>
...
<!-- Footer line -->
<div id="footer">
    <div class="wrapper">As usually all rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">科研训练管理系统</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></div>
</div>
